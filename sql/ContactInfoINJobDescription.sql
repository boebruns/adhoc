...
--              job_source_text,
             ...
             regexp_matches(JobDescription,
                            '[a-zA-Z0-9._\-\s]+@[a-zA-Z0-9._\-\s]+\.[a-zA-Z0-9._\-\s]+')                                                                                                                                                         as EmailAddressFound,
             regexp_matches(JobDescription,
                            '\(?[\d]{3}\)?[\s-]?[\d]{3}[\s-]?[\d]{4}')                                                                                                                                                                           as PhoneNumberFound,
             regexp_matches(JobDescription,
...
where cast(stuff2.URLFound as varchar) not like '%w3.org%'
